...
Hi, I’m Kevin Rodriguez. I am a 27-year-old Information System Security Engineer and aspiring penetration tester with a bachelor's degree (B.S.) in Computer Engineering and a master's degree (M.S.) in Cyber Security and Information Assurance. I also currently hold several industry standard certifications including Cisco Certified Networking Associate (CCNA), CompTIA CySA+, CompTIA PenTest+, CompTIA SecurityX, Practical Network Penetration Tester (PNPT), and Offensive Security Certified Practitioner (OSCP).
